				...
				<div class="col-lg-10">
					<div class="wrap d-md-flex">
	      			...
	      			<h3 class="mb-3">Create an account</h3>
							<form action="ReciveData.php" method="Post" class="signup-form">
								<div class="row">
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<div class="form-group d-flex align-items-center">
					      			<label class="label" for="phone">City</label>
					      			<input type="text" class="form-control" placeholder="Aswan" name="phone">
					      		</div>
									</div>
									<div class="col-md-12">
										<div class="form-group d-flex align-items-center">
				              ...
				              <input type="password" class="form-control" placeholder="Password" name="pass">
				            	...
				            	<div class="w-100">
									...
									<div class="col-md-12">
										<div class="form-group">
				            	<button type="submit" class="btn btn-secondary submit p-3 form-control">Create an account</button>
								<h6 style="color:red;">
									<?php 
									session_start();
